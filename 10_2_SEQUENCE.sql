/* SEQUENCE(순서, 연속, 수열)
 - 순차적 번호 자동 발생기 역할의 객체 
	...
	순차적으로 출력	
   	...
   	** SEQUENCE는 주로 PK역할의 칼럼에 삽입되는 값을 만드는 용도로 사용 **
   	--> 인위적 주식별자 
...
-- * CURRVAL 주의사항 *
--> NEXTRVAL 을 먼저 호출해야 CURRVAL 호출이 가능하다!
...
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL,'RH길동');
...
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL,'채길동');
