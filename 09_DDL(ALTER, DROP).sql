...
-- **** DEPT_COPY 의 DEPT_TITLE 컬럼에 NOT NULL 추가 
...
-- ALTER TABLE 테이블명 MODIFY 컬럼명 NULL/NOT NULL; -> NULL 여 변경 
...
--ORA-12899: "KH_KYS"."DEPT_COPY"."DEPT_ID" 열에 대한 값이 너무 큼(실제: 3, 최대값: 2)
...
--> 해결방법
-- 1) 자식, 부모 테이블 순서대로 삭제 
-- 2) ALTER 를 이용해서 FK제약조건 삭제 후 tb1 삭제
-- 3) DROP TABLE 삭제옵션 CASCADE CONSTRAINTS 사용
--			 CASCADE CONSTRAINTS  : 삭제하려는 테이블과 연결된 FK 를 삭제하고 테이블 삭제 
...
INSERT INTO TB2 VALUES(17,7);
INSERT INTO TB2 VALUES(16,6);

INSERT INTO TB2 VALUES(18,8);
