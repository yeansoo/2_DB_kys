/*
	...
	*** VIEW 사용시 주의사항 ***
	...
	가능한 경우도 있지만 많은 제약이 따르기 때문에 SELECT 용도로 사용하는 것을 권장 
...
-- ORA-01400: NULL을 ("KH_KYS"."DEPT_COPY2"."DEPT_TITLE") 안에 삽입할 수 없습니다 

--> VIEW 를 이용한 INSERT 시
-- VIEW가 아닌 원본 테이블에 삽입이 진행된다 

-- VIEW에 포함되지 않은 칼럼 (DEPT_TITLE)에는 
-- INSERT시 NULL 이 삽입됨. ('D0',NULL,'L3')

-- 만약 VIEW에 포함되지 않은 칼럼(DEPT_TITLE)에
...
--> WITH READ ONLY 옵션 사용
 ...
 WITH READ ONLY; -- 읽기 전용(SELECT만 가능)  
